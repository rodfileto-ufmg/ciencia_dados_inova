...
-   (Dados abertos do CNPQ)[[http://dadosabertos.cnpq.br/pt_BR/dataset]{target="_blank"}](http://dadosabertos.cnpq.br/pt_BR/dataset){.uri};

-   (Dados abertos da CAPES)[[https://dadosabertos.capes.gov.br/dataset]{target="_blank"}](https://dadosabertos.capes.gov.br/dataset){.uri};
