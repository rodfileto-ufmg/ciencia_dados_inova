...
O Material desta aula bem como *scripts* utilizados encontram-se em [repositório aberto no Github](%5Bhttps://github.com/rodfileto-ufmg/ciencia_dados_inova/tree/main/02_data_colecao){target="_blank"}
...
A disponibilidade de dados e informações depende de capacidades organizacionais ou mesmo de capacidades nacionais gestadas no âmbito de um sistema nacional de inovação.

Neste sentido, Robinson-Garcia e Rafols [-@robinson-garcia] explicam como diferentes contextos nacionais tratam o processo de internacionalização da ciência de forma diferente. Para países menos desenvolvidos, sem capacidade de retenção de mão de obra qualificada, ocorre o risco de fuga de cérebros (brain-drain).
...
Pode-se realizar a contagem bruta de referências em comum entre as duas publicações, ou cálculo de *sobreposição intelectual* [@colavizza2017] que leva em conta a proporção de referências que um par de publicações tem em comum.
...
## Identificando tópicos emergentes: rede de citações
