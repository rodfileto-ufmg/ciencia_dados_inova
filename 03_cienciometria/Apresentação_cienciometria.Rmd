...
O Material desta aula bem como \*scripts\* utilizados encontram-se em [repositório aberto no Github]([https://github.com/rodfileto-ufmg/ciencia_dados_inova/tree/main/02_data_colecao){target="\_blank"}.](https://github.com/rodfileto-ufmg/ciencia_dados_inova/tree/main/02_data_colecao){target="_blank"}.)
